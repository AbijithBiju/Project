...
def violence_nodel(tf,wgts='fightw.hdfs'):
...
def main_fight(vidoss):
    ...
    # print(millis)
    f , precent = pred_fight(model1,datav,acuracy=0.90)
    # millis2 = int(round(time.time() * 1000))
    # print(millis2)
    res_fight = {'violence':f ,'violenceestimation':str(precent),'segment':vidoss.split('/')[-1].split('.')[0]} 
